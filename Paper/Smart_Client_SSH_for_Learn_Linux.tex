...
\subsection{Arquitectura Transaccional y Emisión de Eventos (Core Subsystem)}
...
\subsection{Arquitectura Cognitiva y Modelado Sensible al Contexto (Agent Subsystem)}
...
\subsection{Gobernanza Académica e Integración LMS (Plataforma Institucional)}
